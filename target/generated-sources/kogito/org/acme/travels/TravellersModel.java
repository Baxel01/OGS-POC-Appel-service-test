...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "travellers", name = "Travellers", hidden = false)
public class TravellersModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<TravellersModelOutput> {
    ...
    @Override()
    public TravellersModelOutput toModel() {
        TravellersModelOutput result = new TravellersModelOutput();
        result.setId(getId());
